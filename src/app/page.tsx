...
import { Section, Container, Card, CardHeader, CardTitle, CardDescription, buttonVariants } from "@/components/ui";
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mt-3 font-display text-4xl font-bold leading-tight text-neutral-900 sm:text-5xl">
                Your health, <span className="text-primary">handled with care</span>.
              </h1>
            ...
            <div className="flex aspect-square items-center justify-center rounded-2xl bg-gradient-to-br from-primary-light to-secondary-light">
              <Pill className="h-32 w-32 text-primary" strokeWidth={1.25} aria-hidden="true" />
            </div>
          </div>
        </Container>
      </Section>
            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-2 text-sm text-primary-light sm:flex-row sm:gap-6">
                <span className="flex items-center justify-center gap-2 sm:justify-start">
                  <Phone className="h-4 w-4" aria-hidden="true" /> (000) 000-0000
                </span>
                <span className="flex items-center justify-center gap-2 sm:justify-start">
                  <Mail className="h-4 w-4" aria-hidden="true" /> info@bmrpharmacy.com
                </span>
                <span className="flex items-center justify-center gap-2 sm:justify-start">
                  <MapPin className="h-4 w-4" aria-hidden="true" /> 123 Main Street
                </span>
              </div>
            </div>
